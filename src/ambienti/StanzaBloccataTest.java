...
class StanzaBloccataTest {
	...
	void test_stanza_senza_pass() {
		...
		assertSame(this.mia_stanza_bloccata.getStanzaAdiacente("ovest"), this.mia_stanza_bloccata);
		//vado nella direzione non bloccata
		assertSame(this.mia_stanza_bloccata.getStanzaAdiacente("nord"), nuova);
	}
	...
	void test_stanza_con_pass() {
		...
		Stanza nuova=new Stanza("nuova");
		this.mia_stanza_bloccata.impostaStanzaAdiacente("ovest", nuova);
		assertSame(this.mia_stanza_bloccata.getStanzaAdiacente("ovest"), nuova);
	}
